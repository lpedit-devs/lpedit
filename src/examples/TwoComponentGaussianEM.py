...
class TwoComponentGaussian():
    ...
    def run_em_algorithm(self, numIters, numRuns, verbose = True):
        ...
        for j in range(numRuns):
            ...
            if self.verbose == True:
                print 'run: ',j + 1,'mu1: ',round(parms['mu1'],2),'mu2: ',round(parms['mu2'],2),'sig1: ',round(parms['sig1'],2),
                print 'sig2: ',round(parms['sig2'],2),'pi: ',round(parms['pi'],2),'likli: ', round(logLike,4)
