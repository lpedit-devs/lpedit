...
^^^^^^^^^^^^^^^^^^^^^^
   ...
   1. :doc:`LaTeX </Latex>` - a working version of :math:`\textrm{\LaTeX}` installed
   2. :doc:`R </R>` - a current version of the statistical language R
   3. :doc:`Editor </Editor>` - an editor that compiles :doc:`Sweave </Sweave>`
   4. :doc:`BUGS <BUGS>` - Though several software are available we recommend `JAGS <http://mcmc-jags.sourceforge.net>`_
   5. Install `rjags` and `R2jags` - See the :doc:`BUGS <BUGS>` page for more info
